...
class HeadButton extends Button {
    ...
    constructor() {
        ...
        super(ViewerRscManager.Handle.getResource("keylocation", "drop_head.png").texture);

        this.mCurser = new PIXI.Sprite(ViewerRscManager.Handle.getResource("keylocation", "drop_curser.png").texture);
...
class ComboRenderer extends Renderer {
    ...
    draw() {
        ...
        this.mNormalTexture = ViewerRscManager.Handle.getResource( "keylocation", "drop_list_normal.png").texture;
        this.mSelTexture = ViewerRscManager.Handle.getResource( "keylocation", "drop_list_over.png").texture;
...
export class KeyLocationComboBox extends ComboBox {
