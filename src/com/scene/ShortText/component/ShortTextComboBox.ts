...
class HeadButton extends Button {
    ...
    constructor() {
        ...
        super(ViewerRscManager.Handle.getResource("shorttext", "drop_head.png").texture);

        this.mCurser = new PIXI.Sprite(ViewerRscManager.Handle.getResource("shorttext", "drop_curser.png").texture);
        this.mCurser.anchor.set(0.5, 0.5);
        this.mCurser.position.set(605,58);
...
class ComboRenderer extends Renderer {
    ...
    draw() {
        ...
        this.mNormalTexture = ViewerRscManager.Handle.getResource( "shorttext", "drop_list_normal.png").texture;
        this.mSelTexture = ViewerRscManager.Handle.getResource( "shorttext", "drop_list_over.png").texture;
...
export class ShortTextComboBox extends ComboBox {
