...
class HeadButton extends Button {
    ...
    constructor() {
        ...
        super(ViewerRscManager.Handle.getResource("longText", "longTextHeadBtn.png").texture);

        this.mCurser = new PIXI.Sprite(ViewerRscManager.Handle.getResource("longText", "drop_curser.png").texture);
...
class ComboRenderer extends Renderer {
    ...
    draw() {
        ...
        this.mNormalTexture = ViewerRscManager.Handle.getResource( "longtext", "drop_list_normal.png").texture;
        this.mSelTexture = ViewerRscManager.Handle.getResource( "longtext", "drop_list_over.png").texture;
...
export class LongTextComboBox extends ComboBox {
