...
//
import { BaseContainer } from './forest/BaseContainer';
import { EnemyContainer } from './forest/EnemyContainer';
import { CharactersContainer } from './forest/CharactersContainer';
...
export class ForestGame extends SceneBase
{
    ...
    async onInit()
    {
        ...
        //보너스 컨테이너
        this.mBonuseContainer = new BonusContainer(1);
        ...
        //입력 컨테이너 -----------------------------------------
        this.mInputContainer = new InputContainer("forestgame");
    ...
    async onStart()
    {
        ...
        SoundManager.Handle.BGM_ForestGame();
    ...
    {
        SoundManager.Handle.Effect_FOREST_LIFE_DECREASE();
        this.mScoreBoardContainer.lifeReduce();
        this.mBaseContainer.crash();
        this.mCharactersContainer.crash();
    }
     // EnemyContainer ->
    ...
    private showEopPopup()
    {
        ...
        eop.addCustomEventListener( EventType.ReceiveData, async()=> {
            ...
            const dep2 = (LanguageManager.Handle.LANG == 'kr')? '710001' : '720001'
